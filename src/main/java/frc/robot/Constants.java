...
public final class Constants {
  ...
  private static final class MustTune {   /* TODO: Tune All Variables */
  ...
  public static final class Swerve {
    ...
    public static final COTSFalconSwerveConstants chosenModule = MustTune.chosenModule;

    /* Drivetrain Constants */
    public static final double trackWidth = MustTune.trackWidth;
    public static final double wheelBase = MustTune.wheelBase;
    ...
    public static final double driveKP = MustTune.driveKP;
     ...
     */
    public static final double driveKS = MustTune.driveKS;
    public static final double driveKV = (1.51 / 12);
    public static final double driveKA = (0.27 / 12);

    /* Swerve Profiling Values */
    /** Meters per Second */
    public static final double maxSpeed = MustTune.maxSpeed;
    public static double testSpeed = 0.2;
    /** Radians per Second */
    public static final double maxAngularVelocity = MustTune.maxAngularVelocity;
    ...
    /* Front Right Module - Module 0 */
    public static final class Mod0 {
      public static final int driveMotorID = MustTune.Mod0.driveMotorID;
      public static final int angleMotorID = MustTune.Mod0.angleMotorID;
      public static final int canCoderID = MustTune.Mod0.canCoderID;
      public static final Rotation2d angleOffset = MustTune.Mod0.angleOffset;
      public static final SwerveModuleConstants constants = MustTune.Mod0.constants;
    }

    /* Front Left Module - Module 1 */
    public static final class Mod1 {
      public static final int driveMotorID = MustTune.Mod1.driveMotorID;
      public static final int angleMotorID = MustTune.Mod1.angleMotorID;
      public static final int canCoderID = MustTune.Mod1.canCoderID;
      public static final Rotation2d angleOffset = MustTune.Mod1.angleOffset;
      public static final SwerveModuleConstants constants = MustTune.Mod1.constants;
    }
    /* Back Left Module - Module 2 */
    public static final class Mod2 {
      public static final int driveMotorID = MustTune.Mod2.driveMotorID;
      public static final int angleMotorID = MustTune.Mod2.angleMotorID;
      public static final int canCoderID = MustTune.Mod2.canCoderID;
      public static final Rotation2d angleOffset = MustTune.Mod2.angleOffset;
      public static final SwerveModuleConstants constants = MustTune.Mod2.constants;
    }

    /* Back Right Module - Module 3 */
    public static final class Mod3 {
      public static final int driveMotorID = MustTune.Mod3.driveMotorID;
      public static final int angleMotorID = MustTune.Mod3.angleMotorID;
      public static final int canCoderID = MustTune.Mod3.canCoderID;
      public static final Rotation2d angleOffset = MustTune.Mod3.angleOffset;
      public static final SwerveModuleConstants constants = MustTune.Mod3.constants;
    }
  ...
  public static final class AutoConstants {                                
    public static final double kMaxSpeedMetersPerSecond = MustTune.kMaxSpeedMetersPerSecond;
    public static final double kMaxAccelerationMetersPerSecondSquared = MustTune.kMaxAccelerationMetersPerSecondSquared;
    public static final double kMaxAngularSpeedRadiansPerSecond = MustTune.kMaxAngularSpeedRadiansPerSecond;
    public static final double kMaxAngularSpeedRadiansPerSecondSquared = MustTune.kMaxAngularSpeedRadiansPerSecondSquared;

    public static final double kPXController = MustTune.kPXController;
    public static final double kPYController = MustTune.kPYController;
    public static final double kPThetaController = MustTune.kPThetaController;

    /* Constraint for the motion profilied robot angle controller */
    public static final TrapezoidProfile.Constraints kThetaControllerConstraints = MustTune.kThetaControllerConstraints;
  }
  ...
  public static class Arm {
    ...
    public static class SetPoint {
      ...
      public static final PathPoint generalIntakePosition = new PathPoint(new Translation2d(0.59, -0.04),
