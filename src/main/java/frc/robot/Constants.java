...
public final class Constants {
  ...
  public static class Arm {
    ...
    public static class SetPoint {
      ...
      static {
        for (PathPoint point : List.of(cubeHighPosition, coneHighPosition, cubeMediumPosition, coneMediumPosition,
            lowPosition, loadingZonePosition, upIntakePosition, generalIntakePosition, stowPosition, startPosition)) {
          EnumSet<ViolationType> violations = frc.robot.subsystems.Arm.checkArmPointViolation(
              new Vector2D(point.position), EnumSet.noneOf(frc.robot.subsystems.Arm.ViolationType.class)).violation;
          ...
          for (int i = 0; i < 10; i++) {
            if (!violations.isEmpty()) {
              ...
              DriverStation.reportError("Set point " + point.name + " is not possible due to " + violations.toString(),
                  true);
            }
          }
